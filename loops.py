...
#power(number,power) = number * power(number, power - 1)
    ...
    # the stopping case for the loops is i == 0
    ...
    Args:
        ...
        target (_type_): the element to search for


    Returns:
    int: If target appears in the list, indez of the element
